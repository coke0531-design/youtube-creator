// ---------------------------------------------------------------------------
// 출처: HyperFrames (HeyGen) — https://github.com/heygen-com/hyperframes
//   원본 경로: packages/cli/src/commands/contrast-audit.browser.js
//   커밋: 7170dc63ae78dba6ddb211179b453bedf74932a6 (2026-08-26)
//   라이선스: Apache-2.0 (리포 LICENSE 원문 준수)
//   수정 여부: 무수정 발췌(byte-identical). youtube-creator의
//     scripts/hf_audit.py가 이 파일을 문자열로 읽어 presentation.html에 주입한다.
//     한글 라벨 재보정(ATOMIC_LABEL_MAX_CHARS 16 → 8)은 파일을 고치지 않고
//     주입 시점에 문자열 치환으로 적용한다(런타임 오버라이드).
//   갱신 정책: `skills update` 자동 갱신 금지. 위 커밋 고정.
// ---------------------------------------------------------------------------
